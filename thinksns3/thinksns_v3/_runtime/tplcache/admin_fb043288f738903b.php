...
function changeverify(){
    ...
    var url = "<?php echo U('admin/Public/verify');?>";
            ...
            <div class="login">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <img src="<?php echo U('admin/Public/verify');?>" id="verifyimg" alt="<?php echo L('PUBLIC_CHANGE_ONE');?>"  style="vertical-align:middle;padding:0 5px 0 0" onclick="changeverify()"/><!--<a href="javascript:void(0);" onclick="changeverify()">看不清，换一张</a>--> </div>
                    </li>
                    <li>
