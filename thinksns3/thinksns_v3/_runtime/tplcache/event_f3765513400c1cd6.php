  ...
  <!--推荐活动END-->
      ...
      <div class="mainbox_appC">
        <div class="tab-menu">
          <!-- 切换标签 begin  -->
          <ul>
            <li <?php echo (empty($_GET['order']) || $_GET['order']=='hot')?'class="current"':NULL; ?>><a href="<?php echo U('//',array('order'=>'hot'));?>" ><span>热门<?php echo ($ts['app']['app_alias']); ?></span></a></li>
            <li <?php echo ($_GET['order']=='new')?'class="current"':NULL; ?>><a href="<?php echo U('//',array('order'=>'new'));?>" ><span>最新<?php echo ($ts['app']['app_alias']); ?></span></a></li>
            <li <?php echo ($_GET['order']=='following')?'class="current"':NULL; ?>><a href="<?php echo U('//',array('order'=>'following'));?>"><span>我关注的<?php echo ($ts['app']['app_alias']); ?></span></a></li>
          </ul>
        </div>
            <div class="pollBox">
  <div class="LogList">
