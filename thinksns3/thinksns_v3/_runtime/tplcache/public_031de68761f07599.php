<?php if (!defined('THINK_PATH')) exit();?><div class="person-info clearfix border-b mb20">
	...
	<ul class="person-info-b clearfix mb10">
		...
		<li><a href="<?php echo U('public/Index/eventCount');?>" <?php if(($current)  ==  "eventCount"): ?>class="current"<?php endif; ?>><span>发起活动</span><strong event-node="eventCount" event-args="uid=<?php echo ($GLOBALS['ts']['mid']); ?>"><?php echo (($eventCount)?($eventCount):0); ?></strong></a></li>
		<li><a href="<?php echo U('public/Index/joinCount');?>" <?php if(($current)  ==  "joinCount"): ?>class="current"<?php endif; ?>><span>参与活动</span><strong event-node="joinCount" event-args="uid=<?php echo ($GLOBALS['ts']['mid']); ?>"><?php echo (($joinCount)?($joinCount):0); ?></strong></a></li>
