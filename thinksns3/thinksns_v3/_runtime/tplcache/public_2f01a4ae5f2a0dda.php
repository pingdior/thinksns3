...
<div class="person-info clearfix">
    ...
    <ul class="person-info-b clearfix">
        ...
        <li ><a href="<?php echo U('public/Profile/follower',array('uid'=>$user_info[$uid]['uid']));?>"
		...
		<!-- 发起活动 <?php echo U('public/Profile/eventCount',array('uid'=>$user_info[$uid]['uid']));?> 
			参与活动<?php echo U('public/Profile/joinCount',array('uid'=>$user_info[$uid]['uid']));?>
		-->
		 <li ><a href="#"
         <?php if((ACTION_NAME)  ==  "eventCount"): ?>class="current"<?php endif; ?>><span>发起活动</span><strong event-node="eventCount" event-args="uid=<?php echo ($user_info[$uid]['uid']); ?>"><?php echo (($eventCount)?($eventCount):0); ?></a></strong></li>

		 <li class="no-border"><a href="#"
         <?php if((ACTION_NAME)  ==  "joinCount"): ?>class="current"<?php endif; ?>><span>参与活动</span><strong event-node="joinCount" event-args="uid=<?php echo ($user_info[$uid]['uid']); ?>"><?php echo (($joinCount)?($joinCount):0); ?></a></strong></li>        <!-- <li class="no-border <?php if(($current)  ==  "collection"): ?>current<?php endif; ?>"><a href="<?php echo U('public/Collection/index');?>"><span>收藏</span><?php echo (($userData["favorite_count"])?($userData["favorite_count"]):0); ?></a></li> -->
    </ul>
</div>
