...
<?php } ?>
	<div id="page-wrap">
		<div class="reg-wrap">
			<!--登录-->
		    <!--<div class="reg-main">
		    	<div class="article boxShadow clearfix">
		    		<div class="left">
		    		   <dl class="item login-box">
		    		   	   <dd>
		    		   	   	   <div class="form-tt"><i class="text-required">*</i>邮箱：</div>
		    		   	   	   <div class="form-row"><input type="text" class="s-txt"/></div>
		    		   	   </dd>
		    		   	   <dd class="mb8">
		    		   	   ...
		    		   	   <dd class="mb10">
		    		   	   	   ...
		    		   	   	   <div class="form-row"><a href="">忘记密码？</a></div>
		    		   	   </dd>
		    		   	   <dd>
		    		   	   	   <div class="form-tt">&nbsp;</div>
		    		   	   	   <div class="form-row"><a href="" class="btn-green-big"><span>登录</span></a></div>
		    		   	   </dd>
		    		   </dl>
		    		   <div class="login-method">
		    		   	  <h4>第三方账号登录</h4>
		    		   	  <p><a href="" class="ico-sina"></a><a href="" class="ico-qq"></a><a href="" class="ico-tengxun"></a><a href="" class="ico-renren"></a><a href="" class="ico-douban"></a><a href="" class="ico-baidu"></a><a href="" class="ico-taobao"></a></p>
		    		   </div>
		    		</div>
		    		<div class="reg-box left">
		    			<p>还没有帐号？</p>
		    			<p><a href="" class="btn-grey-white">立即注册</a></p>
		    		</div>
		    	</div>
		    </div>-->		
			<div class="reg-main">
				...
				<div class="article boxShadow">
					...
					<dl class="item">
						...
						<dd>
							<div class="form-tt"><i class="text-required">*</i>身份认同：</div>
							<div class="form-row">
								<label><input name="sex" type="radio" class="s-radio" value="1" checked="checked" event-node="radio" event-args="error=<?php echo L('PUBLIC_CHOOSE_GENDER');?>" />T</label>
								<label><input event-node="radio" type="radio" name="sex" value="2" class="s-radio" />P</label>
								<label><input event-node="radio" type="radio" name="sex" value="3" class="s-radio" />H</label>
								<label><input event-node="radio" type="radio" name="sex" value="4" class="s-radio" />HT</label>
								<label><input event-node="radio" type="radio" name="sex" value="5" class="s-radio" />HP</label>
								<label><input event-node="radio" type="radio" name="sex" value="6" class="s-radio" />其他</label>
							</div>
						</dd>
                                <dd>
					<div class="form-tt"><i class="text-required">*</i>职业：</div>
					<div class="form-row">
                                        <input class="s-txt"  event-note="profession"  name="profession" " type="text" value="" />
                                        </div>
                                </dd>
                                <dd>
					<div class="form-tt">年龄：</div>
					<div class="form-row">
                                        <input class="s-txt" event-note="age"  name="age" " type="text" value="" />
                                        </div>
                                </dd>
				<dd>
			...
			<!--设置账号-->
			<!--<div class="reg-main">
				<?php if(($config["register_type"])  !=  "closed"): ?><form model-node="normal_form" method="POST" action="<?php echo U('public/Register/doStep1');?>" name="ajax_register_form" id="ajax_register_form">
				<input type="hidden" name="invate_key" value="<?php echo ($invate_key); ?>" >
			
				<div class="article boxShadow">
					<div class="title">
						<dl class="account-links clearfix">
							<dt><img src="__THEME__/public/image/face.jpg" width="50" height="50"/></dt>
							<dd><h4>欢迎你，hemumlw，新浪微博帐号授权成功！</h4><p>接下来完成简单的设置，即可用新浪微博帐号直接登录ThinkSNS。</p></dd>
						</dl>
					</div>
					<dl class="item">
						<dd>
						...
						<dd>
							<div class="form-tt"><i class="text-required">*</i>绑定邮箱：</div>
							<div class="form-row" style="z-index:99">
								<input event-node="email" event-args="<?php if('appoint' == $config['register_type']): ?>suffix=<?php echo ($config['email_suffix']); ?><?php endif; ?>" name="email" checkurl="<?php echo U('public/Register/isEmailAvailable');?>" autocomplete="off" type="text" value="" />
							</div>
						</dd>
						<dd>
						...
						<dd class="mt15">
							<div class="form-tt"></div>
							<div class="form-row actionBtn">
								<a class="btn-register" href="javascript:;" onclick="$('#ajax_register_form').submit();return false;">确定</a>
							</div>
						</dd>
					</dl>
				</div>
			...
			<!--<div class="reg-main">
              <div class="article boxShadow">
				<div class="invite-reg">
					<div class="tit"><h4>Hi，欢迎来到ThinkSNS社区，这是来自hemumlw给您发出的邀请。您可以</h4><a href="" class="btn-grey-white">立即注册</a></div>
					<div class="login-other clearfix">
						<p>或者直接用以下帐号登录</p>
						<ul>
							<li><a href="" class="btn-sina"></a></li>
							<li><a href="" class="btn-qq"></a></li>
							<li><a href="" class="btn-tengxun"></a></li>
							<li><a href="" class="btn-baidu"></a></li>
							<li><a href="" class="btn-douban"></a></li>
							<li><a href="" class="btn-renren"></a></li>
							<li><a href="" class="btn-taobao"></a></li>
						</ul>
					</div>
				</div>
			  </div>
