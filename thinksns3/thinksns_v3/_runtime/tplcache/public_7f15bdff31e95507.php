...
<div class="app-add"><a href="<?php echo U('public/App/index');?>" class="app"><i class="icon ico-add"></i><?php echo L('PUBLIC_APP_INEX');?></a></div>
	...
	<?php echo Addons::hook('show_ad_space', array('place'=>'home_right_bottom'));?>
                    ...
                    <div class="tab-menu">
                        ...
                        <ul>
                            <?php switch($type): ?><?php case "all":  ?><li class="current"><span><a href="<?php echo U('public/Index/index',array('type'=>'all'));?>"><?php echo L('PUBLIC_ACTIVITY');?></a></span></li>
                                <li><span><a href="<?php echo U('public/Index/index',array('type'=>'following'));?>"><?php echo L('PUBLIC_ACTIVITY_STREAM');?><i class="arrow-down"></i></a></span></li>
                                ...
                                <?php case "following":  ?><li><span><a href="<?php echo U('public/Index/index',array('type'=>'all'));?>"><?php echo L('PUBLIC_ACTIVITY');?></a></span></li>
                                <li class="current" model-node="myfollow"><span><a href="javascript:void(0);" title="<?php echo ($groupname); ?>"><?php echo (getShort($groupname, 4)); ?><i class="arrow-down"></i></a></span></li> 
                                <?php if(($isChannelOpen)  ==  "true"): ?><li><span><a href="<?php echo U('public/Index/index',array('type'=>'channel'));?>">我关注的频道<i class="arrow-down"></i></a></span></li><?php endif; ?><?php break;?>
                                <?php case "channel":  ?><li><span><a href="<?php echo U('public/Index/index',array('type'=>'all'));?>"><?php echo L('PUBLIC_ACTIVITY');?></a></span></li>
                                <li><span><a href="<?php echo U('public/Index/index',array('type'=>'following'));?>"><?php echo L('PUBLIC_ACTIVITY_STREAM');?><i class="arrow-down"></i></a></span></li>      
