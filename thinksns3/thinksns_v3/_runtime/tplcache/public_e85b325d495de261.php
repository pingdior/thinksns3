...
<?php } ?>
    ...
    <div class="right-wrap">
    	<!-- <div class="topic-title mb20 clearfix">
    		<a href="" class="left"><i class="ico-topic-add"></i><span>关注该话题</span></a>
            <a href="" class="right"><i class="ico-topic-rec"></i><span>推荐该话题</span></a>
    	</div> -->
        <?php if($topics['topic_user']){ ?>
            <div class="attention mb20 clearfix border-b">   
                <h3>话题人物推荐</h3>
                <?php echo W('TopicUser',array('topic_id'=>$topics['topic_id'], 'type'=>1));?>    
            </div>
        <?php } ?>
        <div class="attention mb20 clearfix border-b">
            <h3>参与该话题的人</h3>
            <?php echo W('TopicUser',array('topic_id'=>$topics['topic_id'], 'type'=>2, 'limit'=>8));?>
        </div>
        <!--推荐话题-->
        <?php echo W('TopicList',array('type'=>1, 'limit'=>10));?>
        <!-- 话题右下 -->
        <div style="margin-top:10px;width:230px;overflow:hidden;">
        <?php echo Addons::hook('show_ad_space', array('place'=>'topic_right'));?>
                    ...
                    <div class="topic-info">
                        <h3 class="mb20">话题: <?php echo ($topics['topic_name']); ?></h3>
                        <?php if($topics['pic']!=""){ ?><img src="<?php echo ($topics['pic']); ?>" width="620" height="200"/><?php } ?>
                        <p class="mb20"><?php if($topics['des']){ ?><?php echo ($topics['des']); ?><?php } ?><?php if($topics['outlink']){ ?><a href="<?php echo ($topics[outlink]); ?>" target="_blank">>>详细</a><?php } ?></p>
                    </div>
                    <!--发布框-->
                    <?php echo W('SendWeibo',array('title'=>L('PUBLIC_WEIBO_TIPS'),'initHtml'=>$initHtml));?>
                    <!--feednav-->
                    <div class="feed-nav">
                    <!--tab menu-->
                    <div class="tab-menu">
                        ...
                        <div class="feed-group">该话题共有"<a href=""><?php echo ($topics['count']); ?></a>"条相关微博</div>
                        <ul>
                            <li class="current"><span><a href="#" >相关微博</a></span></li>            
                        </ul>
                    </div>
                    <!-- <div class="mod-feed-tab" id="mod-feed-tab" <?php if(!isset($_GET['feed_type']) && empty($_GET['feed_key'])){ ?> style="display:none"<?php } ?> >
                        <ul class="inner-feed-nav">
                            <li <?php if(($feed_type)  ==  ""): ?>class="current"<?php endif; ?>>
                                <a href="<?php echo U('public/Topic/index',array('feed_type'=>''));?>"><?php echo L('PUBLIC_ALL_STREAM');?></a></li>
                            <li <?php if(($feed_type)  ==  "post"): ?>class="current"<?php endif; ?>>
                            <a href="<?php echo U('public/Topic/index',array('feed_type'=>'post'));?>"><?php echo L('PUBLIC_ORIGINAL_STREAM');?></a></li>
                            <li <?php if(($feed_type)  ==  "repost"): ?>class="current"<?php endif; ?>>
                            <a href="<?php echo U('public/Topic/index',array('feed_type'=>'repost'));?>"><?php echo L('PUBLIC_SHARE_STREAM');?></a></li>
                            <li <?php if(($feed_type)  ==  "postimage"): ?>class="current"<?php endif; ?>>
                            <a href="<?php echo U('public/Topic/index',array('feed_type'=>'postimage'));?>"><?php echo L('PUBLIC_IMAGE_STREAM');?></a></li>
                            <li <?php if(($feed_type)  ==  "postfile"): ?>class="current"<?php endif; ?>>
                            <a href="<?php echo U('public/Index/index',array('feed_type'=>'postfile'));?>"><?php echo L('PUBLIC_FILE_STREAM');?></a></li>
                        </ul>
                    </div> -->
                    </div>
                    <!--feed list-->
                    <?php echo W('FeedList',array('type'=>$type,'feed_type'=>$feed_type,'feed_key'=>$search_key,'fgid'=>t($_GET['fgid']),'topic_id'=>$topic_id));?>
                    </div>
                    </div>
                </div>
            </div>
