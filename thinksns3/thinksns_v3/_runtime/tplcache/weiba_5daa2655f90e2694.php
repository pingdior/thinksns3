                      ...
                      <?php echo Addons::hook('show_ad_space', array('place'=>'weiba_middle'));?>
                        ...
                        <div class="weiba-box">
                          ...
                          <div class="my-weiba-list">
                             <ul>
                               <?php if(is_array($postList["data"])): ?><?php $i = 0;?><?php $__LIST__ = $postList["data"]?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><li><div class="name"><span class="right num"><i class="arrow-weiba"></i><?php echo ($vo["reply_count"]); ?></span><a target="_blank" href="<?php echo U('weiba/Index/postDetail',array('post_id'=>$vo['post_id']));?>"><?php echo ($vo["title"]); ?><?php if(strstr($vo['content'],'<img')){ ?><i class="ico-img"></i><?php } ?></a></div>
                                 <div class="f9"><span class="right"><?php echo ($user_info[$vo['last_reply_uid']]['space_link']); ?>&nbsp;&nbsp;<?php echo (friendlyDate($vo["last_reply_time"])); ?></span><span><?php if($vo['top']==2){ ?><i class="ico-bar-top mr5">置顶</i><?php } ?><?php if($vo['digest']==1){ ?><i class="ico-bar-fine mr5">精华</i><?php } ?>【<?php echo ($vo["weiba"]); ?>】<?php echo ($user_info[$vo['post_uid']]['space_link']); ?>&nbsp;&nbsp;<?php echo (friendlyDate($vo["post_time"])); ?>&nbsp;&nbsp;发布</span></div></li><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
                             </ul>
                           </div>
