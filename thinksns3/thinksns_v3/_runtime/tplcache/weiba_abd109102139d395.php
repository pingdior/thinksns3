                ...
                <div id="col3" class="st-index-right">
                 ...
                 <div id="col5" class="st-index-main">
                    <div class="extend-foot">
                        <div class="tab-menu">
                            <ul>
                                <li <?php if(($type)  ==  ""): ?>class="current"<?php endif; ?>><span><a href="<?php echo U('weiba/Index/myWeiba');?>">我关注的微吧帖子</a></span></li>
                                <li <?php if(($type)  ==  "myPost"): ?>class="current"<?php endif; ?>><span><a href="<?php echo U('weiba/Index/myWeiba',array('type'=>'myPost'));?>">我发表的帖子</a></span></li>
                                <li <?php if(($type)  ==  "myReply"): ?>class="current"<?php endif; ?>><span><a href="<?php echo U('weiba/Index/myWeiba',array('type'=>'myReply'));?>">我回复的帖子</a></span></li>
                                <li <?php if(($type)  ==  "myFavorite"): ?>class="current"<?php endif; ?>><span><a href="<?php echo U('weiba/Index/myWeiba',array('type'=>'myFavorite'));?>">我收藏的帖子</a></span></li>
                            </ul>
                        </div>
                        <div class="weiba_postlist">
                          <?php if($postList['data']){ ?>
                           <ul>
                            <?php if(is_array($postList["data"])): ?><?php $i = 0;?><?php $__LIST__ = $postList["data"]?><?php if( count($__LIST__)==0 ) : echo "" ; ?><?php else: ?><?php foreach($__LIST__ as $key=>$vo): ?><?php ++$i;?><?php $mod = ($i % 2 )?><li>
                                <div class="name"><span class="right num"><i class="arrow-weiba"></i><?php echo ($vo["reply_count"]); ?></span><a target="_blank" href="<?php echo U('weiba/Index/postDetail',array('post_id'=>$vo['post_id']));?>"><span style="vertical-align:-2px;"><?php echo ($vo["title"]); ?></span><?php if(strstr($vo['content'],'<img')){ ?><i class="ico-img"></i><?php } ?><?php if($vo['top']==2){ ?><i class="ico-bar-top ml5">置顶</i><?php } ?><?php if($vo['top']==1){ ?><i class="ico-bar-top0 ml5">置顶</i><?php } ?><?php if($vo['digest']==1){ ?><i class="ico-bar-fine ml5">精华</i><?php } ?></a></div>
                                <div class="f9"><?php if($vo['last_reply_time'] && $vo['last_reply_uid']){ ?><span class="right"><?php echo ($user_info[$vo['last_reply_uid']]['space_link']); ?><span class="pl5 pr5">/</span><?php echo (friendlyDate($vo["last_reply_time"])); ?></span><?php } ?><span>【<?php echo ($vo["weiba"]); ?>】<?php echo ($user_info[$vo['post_uid']]['space_link']); ?><span class="pl5 pr5">/</span><?php echo (friendlyDate($vo["post_time"])); ?>发布</span></div></li><?php endforeach; ?><?php endif; ?><?php else: echo "" ;?><?php endif; ?>
                           </ul>
